    ...
    return (
        <div style={{minWidth: '288px'}} className="bg-white h-96 w-72 rounded-3xl flex flex-col p-5 hover:-translate-y-3 transition-all">
            ...
            <span className="flex flex-cow mt-5 justify-between" >
                <button      className="bg-green-600 w-9 h-9 flex items-center justify-center rounded-3xl hover:-translate-y-1 transition-transform">
                    <i className="fa-solid fa-question text-lg text-white"></i>
                </button>
                <h3 className="text-2xl font-bold">{props.name}</h3>
                <button className="bg-red-500 w-9 h-9 flex items-center justify-center rounded-3xl hover:-translate-y-1 transition-all">
